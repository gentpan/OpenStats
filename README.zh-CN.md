...
尚未发布正式版本 · 开发中 **29** 项改动尚未发布 · [完整更新日志](CHANGELOG.md)

<details open>
<summary><b>2026-09-13</b> · 未发布 · 新增 18 · 样式 5 · 修复 6</summary>
...
面板高度按内容自动计算，常见屏幕上不需要滚动；按 `Esc` 关闭。提供浅色、深色两套主题，
可在面板顶部一键切换或跟随系统；液态玻璃背景可选。
