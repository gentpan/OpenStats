...
struct SystemWidgetView: View {
    ...
    private var header: some View {
        HStack(spacing: 4) {
            ...
            Text("OpenStats").font(.system(size: 12, weight: .semibold)).foregroundStyle(Palette.textPrimary)
            Spacer()
...
struct SystemWidget: Widget {
    var body: some WidgetConfiguration {
        StaticConfiguration(kind: "com.openstats.widget.system", provider: SystemProvider()) { entry in
...
@main
struct OpenStatsWidgets: WidgetBundle {
