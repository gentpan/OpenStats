...
public final class AlertController: NSObject {
    ...
    private func startNetworkMonitor() {
        ...
        monitor.start(queue: DispatchQueue(label: "com.openstats.alerts.network"))
        pathMonitor = monitor
    }
    ...
    func openNotificationSettings() {
        let id = Bundle.main.bundleIdentifier ?? "com.openstats.app"
    ...
    private func send(_ kind: AlertKind, title: String? = nil, body: String) {
        ...
        center.add(UNNotificationRequest(identifier: "openstats.\(kind.rawValue)", content: content, trigger: nil))
    }
